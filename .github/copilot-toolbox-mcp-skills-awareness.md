...
_Generated: 2026-04-06T09:20:42.091Z_
...
Workspace `mcp.json` _(folder: HTML PRACTICE)_

- **c:\Users\somin\OneDrive\Desktop\HTML PRACTICE\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\somin\AppData\Roaming\Code\User\mcp.json** — _File missing_
